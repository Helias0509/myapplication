...
public class UploadFileUtil {
    ...
    public String executeMultiPartRequest(String urlString, File file, String fileName, String fileDescription) {
        ...
        try{
            ...
            multiPartEntity.addPart("filePath", new StringBody(file.getPath()));
    ...
    public static void main(String[] args){
        ...
        fileUpload.executeRequest(httpget);
        
        System.out.println("we come to here");
        
        File file = new File ("HaoZhang/xml2.xml") ;
 
        String response = fileUpload.executeMultiPartRequest("http://localhost:8888", file, file.getName(), "File Upload test Hydrangeas.jpg description") ;
